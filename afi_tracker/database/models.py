...
from afi_tracker.config import DB_FILE, TIMEZONE
...
def get_rating_at_time(target_time: datetime) -> Tuple[Optional[datetime], Optional[int], Optional[List[Tuple[str, int]]]]:
    """
